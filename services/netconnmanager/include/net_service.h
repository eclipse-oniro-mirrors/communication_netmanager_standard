...
public:
    NetService(const std::string &ident, NetworkType networkType,
        NetCapabilities netCapability, sptr<Network> &network);
    ~NetService() = default;
    ...
    /**
     * @brief Initiate a network connection request to the network service of the network supplier
     *
    ...
    /**
     * @brief Initiate a disconnect request to the network service of the network supplier
     *
    ...
    /**
     * @brief Automatically initiate a network connection request to the network service of the network supplier
     *
     * @return Return ERR_SERVICE_REQUEST_SUCCESS, Succeed
     */
     ...
     *
     * @return Return ERR_NONE, Succeed
     */
